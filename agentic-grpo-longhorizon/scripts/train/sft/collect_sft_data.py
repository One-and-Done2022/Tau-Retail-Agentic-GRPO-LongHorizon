"""用教师策略在 τ-bench retail 上进行 best-of-N SFT 数据采集。
...
用法:
    ...
    python scripts/train/sft/collect_sft_data.py --config configs/train/sft/sft_collect_retail.yaml
    # tiny 模式
    python scripts/train/sft/collect_sft_data.py --config configs/train/sft/sft_collect_retail.yaml --tiny
"""
import sys
